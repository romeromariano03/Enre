...
Descarga el dataset completo de normativa nacional de InfoLEG (~424.000 normas) desde el portal de datos abiertos de Argentina
Filtra hasta obtener 1.873 resoluciones del ENRE publicadas entre 2016 y 2025
Preprocesa el texto: elimina lenguaje legal repetitivo (boilerplate), remueve stopwords, normaliza
Entrena BERTopic usando un SentenceTransformer multilingüe (`paraphrase-multilingual-MiniLM-L12-v2`) para descubrir 10 clusters temáticos regulatorios
Recupera outliers mediante reglas léxicas (163 de 186 resoluciones no clasificadas fueron reclasificadas)
Compara la distribución de tópicos entre gestiones usando una ventana equivalente de 18 meses para controlar el sesgo de madurez de gobierno
Visualiza resultados: mapas de calor, series de tiempo y grafos de red interactivos (PyVis)
---
...
├── red_distribuidoras_preview.png      # Captura estática de la red interactiva
└── README.md
```
...
---
Cómo Ejecutarlo
Abrir `ENRE.ipynb` en Google Colab
Ejecutar la Celda 1 — instala `pdfplumber`, `requests`, `beautifulsoup4`, `tqdm`
Ejecutar la Celda 2 — descarga el dataset completo de InfoLEG (~150 MB en ZIP, ~3 min)
Ejecutar las Celdas 3 a 6 — filtra las resoluciones del ENRE, asigna gestiones de gobierno, guarda el corpus
Ejecutar la Celda 7 — instala `bertopic`, `sentence-transformers`, `umap-learn`, `hdbscan`
Ejecutar las Celdas 8 en adelante — pipeline completo de NLP, modelado de tópicos, análisis y visualizaciones
